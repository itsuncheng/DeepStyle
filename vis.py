...
def vis_one_image(
    ...
    for i in sorted_inds:
        ...
        print('class: {}'.format(class_string))
        
        if (class_string == "Full"):
            # save cropped image to a directory
            image = Image.open(im_name)
            cropped = image.crop(bbox)
            cropped.save('/home/ubuntu/data/cropped_images/' + os.path.basename(im_name)[:-4] + '.png', format='PNG')
    ...
    output_name = os.path.basename(im_name)[:-4] + '.' + ext  # added :-4 to remove .jpg extension
